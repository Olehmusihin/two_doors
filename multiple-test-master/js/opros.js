	var checked_img_url = 'https://evgeniyvorobev.github.io/multiple-test/ism/img/checkbox_sellected.png';
	var notchecked_img_url = 'https://evgeniyvorobev.github.io/multiple-test/ism/img/checkbox_notsellected.png';
		...
		// Multiple select.
			...
			/* count number of times each level is repeated */
				...
				if (maxLevel == 'Начальный') {
					$('.interview').append('<p class="result-txt">Дорогой шоумен. Мы уверены, ты классный человек и отличный перспективный ведущий. Но на данный момент мы советуем тебе пройти наш базовый тренинг для ведущих «Простарт». (картинка как вы делаете «афишу», картинка кликабельна и ведет на страницу простарт на проведение сайт). Приходи к нам в #домспроведением. (+ ссылка на контакты на проведение). Обсудим результаты и познакомимся. Хорошего тебе дня</p>')
				}
				if (maxLevel == 'Уверенный') {
					$('.interview').append('<p class="result-txt">Тестирование прошло успешно! Поздравляем. Сейчас ты будешь перенаправлен на страницу покупки билетов. Если не хочешь ждать, жми сюда.</p>')
				}
				if (maxLevel == 'Опытный') {
					$('.interview').append('<p class="result-txt">Тестирование прошло успешно! Поздравляем. Сейчас ты будешь перенаправлен на страницу покупки билетов. Если не хочешь ждать, жми сюда.</p>')
				}
